...
$user_id = $_SESSION['USER_ID'];
 include("includes/connection.php");
$query_category1="SELECT username,password,user_fname,user_mname,user_lname,user_gender,user_age,user_bday,user_contact,user_city,user_state,user_pincode,user_street,user_house_number,user_email FROM user
...
$result_category1 = mysqli_query($conn,$query_category1);
 while($row1 = mysqli_fetch_array($result_category1)){
    ...
    $city = $row1['user_city'];
    $state = $row1['user_state'];
    $pincode = $row1['user_pincode'];
...
<h2 class="headspace font infospace"> Account Information <hr class="hr" style="border-bottom: 4px solid #2a8048;"> </h2>
...
<input type="hidden" name="MAX_FILE_SIZE" value="1000000" />
 ...
 <p class="fsize-text">
        ...
        <h2  class="headspace2 font infospace"> Personal Information <hr class="hr" style="border-bottom: 4px solid #2a8048;"> </h2>
            ...
            City:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input class="textbox" type="text" id="municipal" name="municipal" value="<?php echo $municipal; ?>"><br><br>

            State:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <input class="textbox" type="text" id="province" name="province" value="<?php echo $province; ?>"><br><br>
            Pincode:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input class="textbox" type="text" id="zipcode" name="zipcode" value="<?php echo $zipcode; ?>"><br><br>
     ...
     <h2  class="headspace3 font infospace"> Close Account <hr class="hr" style="border-bottom: 4px solid #2a8048;"> </h2>
