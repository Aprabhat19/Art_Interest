            ...
            while($row1 = mysqli_fetch_array($result_category1))
{
                ...
                echo '<img class="img" src="pictures/arts/'.$row1['art_imagepath'].'" ></a><br />'.'<a href=info_art.php?id='.$row1['art_id'].' class="desc-title"> '.$row1['art_title'].' </a>  <p class="desc-content"> Artist:  '.$row1['user_fname'].' '.$row1['user_mname'].' '.$row1['user_lname'].' <br>Rs '.$row1['art_price'].'</p>';
            }
