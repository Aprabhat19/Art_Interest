 ...
 <head>
  ...
  <style>
        ...
        li a {
          ...
          margin:120px 15px 0px 50px;
          text-decoration: none;

         }

        li a:hover:not(.logo) {
          border-bottom: 2px solid #2a8048;
        }
  ...
  <div class="dpdown-content" style="left:0;">
                   <a href="artworks.php">Artworks</a>
                    <a href="artist.php">Artists</a>
                     ...
                     ------------------------------------<br>
                    <a href="about_us.php"> About ART_INTEREST</a>
  </div>
</div>


  <h1 class="ART">ART </h1>
  <h1 class="_BAY">_INTEREST </h1>
                 ...
                 '<div class="dropdown3">'.
                    '<button onclick="myFunction()" class="dropbtn3">' .$row['user_fname'].' '.$row['user_mname'].' '.$row['user_lname']. ''.''. '&#9660;'. '</button>'.'
                       <div id="myDropdown" class="dropdown-content3">
                        <a href="account_home.php">My ART_INTEREST Admin</a>
