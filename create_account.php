...
<?php include("Database/includes/connection.php");
...
{
$sql="INSERT INTO user (username,password,USER_FNAME,USER_MNAME,USER_LNAME,USER_GENDER,USER_AGE,USER_BDAY,USER_CONTACT,USER_CITY,USER_STATE,USER_PINCODE,USER_STREET,USER_HOUSE_NUMBER,USER_IMAGEPATH,USER_TYPE,USER_EMAIL) VALUES ('$username','$password','$USER_FNAME', '$USER_MNAME','$USER_LNAME','$USER_GENDER',
'$USER_AGE', '$USER_BDAY', '$USER_CONTACT', '$USER_CITY',
'$USER_STATE','$USER_PINCODE','$USER_STREET',
...
<div class="border">
      ...
      <form action = "create_account.php"enctype="multipart/form-data" method="POST">
            <h2 class="headspace font infospace"> Account Information <hr class="hr" style="border-bottom: 2px solid #2a8048;"></h2>
           ...
           <p class="fsize-text"> Username: &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input class="textbox" type="text" required name="username" ><br><br>
            ...
            <h2  class="font infospace"> Personal Information <hr class="hr" style="border-bottom: 2px solid #2a8048;"></h2>
            ...
            City:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input class="textbox" type="text" id="city" name="city" ><br><br>
            State:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input class="textbox" type="text" id="state" name="state"><br><br>
            Pincode:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input class="textbox" type="text" id="pincode" name="pincode"><br><br>
